...
export const Contact = () => {
    ...
    useEffect(() => {
        ...
        const fetchPage = async () => {
            const res = await database.getDocument(db_id, 'essential_pages', 'contact');
            setPage(res)
        }
        fetchPage()
        setProgress(100)
    ...
    return (
        <>
            ...
            <Helmet>
                <title>Contact - EsportsGravity</title>
            </Helmet>
            ...
            <div className='bg-gradient-to-r from-frameBG to-secondaryLight w-full h-52 flex flex-col items-center justify-center gap-3'>
                ...
                <h1 className='text-3xl font-bold text-offWhite flex gap-2 items-center'><span>Contact</span></h1>
            </div>
