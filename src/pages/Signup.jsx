        ...
        <div className="bg-secondary flex flex-col lg:col-span-4 md:col-span-6 col-span-1 md:px-10 px-6 py-10">
          ...
          <div className="flex flex-col gap-3 mt-5">
            <div className="flex border-[0.8px] border-inactive rounded-[3px]">
              ...
              <input type="text" placeholder='Name' className='w-full rounded-[3px] bg-transparent outline-none border-l-[0.8px] border-inactive  p-3 placeholder:opacity-70' />
            </div>
            <div className="flex border-[0.8px] border-inactive rounded-[3px]">
              <div className='px-4 self-center'>
            ...
            <div className="flex border-[0.8px] border-inactive rounded-[3px]">
              ...
              <div className="flex border-l-[0.8px] border-inactive  items-center pl-4 w-full">
                <span>+977 </span>
                <input type="number" placeholder='Phone No.' className='hide-incrementer w-full rounded-[3px] bg-transparent outline-none p-3 placeholder:opacity-70' />
              </div>
            </div>
            <div className="flex border-[0.8px] border-inactive rounded-[3px]">
              <div className='px-4 self-center'>
              ...
              <input type="password" placeholder='Create password' className='w-full rounded-[3px] bg-transparent outline-none border-l-[0.8px] border-inactive  p-3 placeholder:opacity-70' />
            </div>
            ...
            <button className='bg-primary w-full my-2 text-secondary font-bold text-lg py-2 rounded-[3px]'>Sign Up</button>
            ...
            <div className='flex flex-col items-center mt-12'>
              ...
              <label htmlFor="" className='relative bg-secondary -translate-y-[50%] w-fit px-3'>Sign Up With</label>
