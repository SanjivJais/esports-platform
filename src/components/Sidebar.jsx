...
export const Sidebar = ({ sideOpen, mobSideOpen, mobToggleSidebar }) => {
  ...
  return (
    <>
      <div className={`w-64 md:w-72 top-0 px-4 z-50  bg-secondary transition-all duration-300 h-screen md:text-[16px] text-[14px] ${sideOpen ? 'md:sticky md:left-0 left-0' : 'md:fixed md:-left-72'} fixed ${mobSideOpen ? 'left-0' : '-left-64'}`}>
