  ...
  return (
    <nav className="sticky top-0 bg-secondary h-[72px] md:px-6 shadow-md flex items-center justify-between pl-0 pr-6">
      ...
      <div className="flex gap-3">
        <div className="flex bg-secondaryLight items-center rounded-[3px] px-6"><input type="text" className='bg-transparent focus:outline-none w-full' placeholder='Search' /><GoSearch className='text-lg text-inactive' /></div>
